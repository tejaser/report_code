...
def summary(account=None):
    ...
    lm_fb_reach, lm_fb_clicks, lm_fb_impression, cm_fb_reach, cm_fb_clicks, cm_fb_impression = [0 for _ in range(6)]
    ...
    if((lm_ga_rev == 0.0) or (lm_fb_rev == 0.0) or (lm_fb_reach == 0) or (lm_fb_clicks == 0) or (lm_fb_impression == 0) or (lm_ga_orders == 0)):
        ...
        fb_impression_change = ((cm_fb_impression - lm_fb_impression)/lm_fb_impression) * 100
